...
xst -ifn xst.scr
move TesterPLLD_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\TesterPLLD_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc TesterPLLD_exdes.ucf TesterPLLD_exdes

echo 'Running map'
map -timing -pr b TesterPLLD_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm TesterPLLD_exdes -w routed.ncd routed.v
cd ..
