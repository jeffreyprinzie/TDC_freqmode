...
xst -ifn xst.scr
move TesterPLL_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\TesterPLL_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc TesterPLL_exdes.ucf TesterPLL_exdes

echo 'Running map'
map -timing -pr b TesterPLL_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm TesterPLL_exdes -w routed.ncd routed.v
cd ..
